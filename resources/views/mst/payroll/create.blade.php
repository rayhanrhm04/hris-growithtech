...
<head>
    ...
    <title>Payroll | HRIS Growithtech</title>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">New Payroll Data</h1>
                        </div>
                                            ...
                                            <div class="col">
                                                <form action="{{ route('payroll.store') }}" method="POST">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input class="form-control" name="meal_allowances" id="meal_allowances">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input class="form-control" name="project_bonus" id="project_bonus">
                                                        </div>
                                                    </div>
